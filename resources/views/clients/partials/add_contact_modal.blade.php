<div id="contactModal" class="fixed inset-0 bg-black bg-opacity-50 flex p-2 justify-center items-center hidden">
    <!-- Modal Dialog -->
            ...
            <section>
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input id="comment" type="text" name="comment" class="mt-1 block w-full border border-gray-300 rounded-md py-1 px-3">
                    </div>
