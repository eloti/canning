            ...
            <section>
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="col-span-1">
                        ...
                        <input id="name" type="text" name="name" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 {{ $errors->has('name') ? 'border-red-500' : '' }}">
                        @if ($errors->has('name'))
                    ...
                    <div class="col-span-1">
                        ...
                        <input id="position" type="text" name="position" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3">
                    </div>

                    <!-- E-mail -->
                    <div class="col-span-1">
                        <label for="email" class="block text-md font-medium text-gray-700">E-mail</label>
                        <input id="email" type="email" name="email" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3">
                    </div>

                    <!-- Celular -->
                    <div class="col-span-1">
                        <label for="cell_phone" class="block text-md font-medium text-gray-700">Celular</label>
                        <input id="cell_phone" type="text" name="cell_phone" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3">
                    </div>

                    <!-- Teléfono fijo -->
                    <div class="col-span-1">
                        <label for="phone" class="block text-md font-medium text-gray-700">Teléfono fijo</label>
                        <input id="phone" type="text" name="phone" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3">
                    </div>
