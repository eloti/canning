        ...
        <form method="POST" action="{{ route('addresses.store') }}" autocomplete="off"  class="p-4 space-y-6">
            ...
            <section>
                ...
                <div class="flex justify-end space-x-4 mt-6">
                    ...
                    <a id="cancelModalButton2" type="button" class="py-2 px-4 bg-gray-600 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2" href="{{ url()->previous() }}">Cancelar</a>
                </div>
