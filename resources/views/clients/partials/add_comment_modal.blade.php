    ...
    <div class="bg-white rounded-lg w-full max-w-3xl">
        ...
        <form method="POST" id="contactModalForm" action="{{ route('comments.store') }}" autocomplete="off" class="p-4 space-y-6">
            ...
            <div class="flex justify-end space-x-4 mt-6">
                ...
                <button type="button" id="cancelModalButton3" class="py-2 px-4 bg-gray-600 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Cancelar</button>
            </div>
