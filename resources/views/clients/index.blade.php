    ...
    <div class="bg-white rounded-lg w-full max-w-3xl p-2">
        ...
        <form method="POST" action="{{ route('clients.store') }}" autocomplete="off" class="p-1">
            ...
            <div class="space-y-4">
               ...
               <div class="grid grid-cols-2 gap-4">
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" id="legal_name" name="legal_name" value="{{ old('legal_name') }}" class="mt-0 form-input w-full border border-gray-300 rounded p-1{{ $errors->has('legal_name') ? ' border-red-500' : '' }}">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" id="cuit_num" name="cuit_num" value="{{ old('cuit_num') }}" class="mt-0 form-input w-full border border-gray-300 rounded p-1{{ $errors->has('cuit_num') ? ' border-red-500' : '' }}">
               ...
               <div class="flex flex-col space-y-2">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" id="sales_tax_rate" name="sales_tax_rate" value="{{ old('sales_tax_rate') }}" class="mt-0 form-input w-full border border-gray-300 rounded p-1{{ $errors->has('sales_tax_rate') ? ' border-red-500' : '' }}">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <div class="space-x-2">
                    <button type="submit" class="bg-rental text-white font-bold py-2 px-4 rounded hover:bg-rentallight">Guardar</button>
