...
<div class="container eagle-container">
  ...
  <div class="jumbotron eagle-jumbotron-2">
    <div class="row eagle-row" style="margin: 0; padding: 0 1rem 0 1rem">
      <h1 class="col-11 eagle-h2" style="display: flex; align-items: center; padding: 0">Crear Nuevo Alquiler</h1>
  ...
  <form class="col-12 rental-form" method="POST" action="{{ route('rentals.store') }}" autocomplete="off" id="formulario">
    {{csrf_field()}}
    ...
    <div class="row rental-row"> <!-- start of form row -->
      ...
      <div class="col-3">
        ...
        <div class="row eagle-row-clean col-12">
          ...
          <select id="contact" data-old="{{ old('contact_id') }}" name="contact_id" class="col-8 form-control mac-form-control{{ $errors->has('contact_id') ? ' is-invalid' : '' }}"></select>
        </div>

        <div class="row eagle-row-clean col-12">
          <label for="address" class="mac-label-left col-4">Dirección de entrega:</label>
          <select id="address" data-old="{{ old('address_id') }}" name="address_id" class="col-8 form-control mac-form-control{{ $errors->has('address_id') ? ' is-invalid' : '' }}"></select>
        </div>
        ...
        <div class="row eagle-row-clean col-12">
          ...
          <textarea id="aux" type="text" name="aux" class="col-8 form-control mac-form-control textarea-desc" value="{{old('aux')}}"></textarea>
        </div>
      ...
      <div class="col-3"> <!-- 2nd column -->
          ...
          <div class="row eagle-row-clean col-12">
            ...
            <select id="family" name="family_id" class="col-8 form-control mac-form-control{{ $errors->has('family_id') ? ' is-invalid' : '' }}">
              @foreach($families->get() as $index => $family)
                <option value="{{ $index }}" {{ old('family_id') == $index ? 'selected' : '' }}>
                  {{ $family }}
                </option>
              @endforeach
            </select>
          ...
          <div class="row eagle-row-clean col-12">
            ...
            <select id="unit_model" name="unit_model_id" class="col-8 form-control mac-form-control" data-old="{{ old('unit_model_id') }}"></select>
              <span class="col-12 invalid-feedback d-none text-center" role="alert" style="padding: 0">
          ...
          <div class="row eagle-row-clean col-12">
            ...
            <div class="row eagle-row-clean col-6">
              ...
              <input id="available" type="text" name="available" class="mac-form-control-readonly col-4" style="text-align: center;" readonly>
              <div class="col-2"></div>
            </div>

            <div class="row eagle-row-clean col-6">
              <label for="quantity" class="mac-label-left col-6">Cantidad:</label>
              <input id="quantity" type="text" name="quantity" class="form-control mac-form-control col-4" value="{{old('quantity')}}"> 
              <div class="col-2"></div>
              <span class="col-12 invalid-feedback d-none text-center" role="alert" style="padding: 0">
          ...
          <div class="row eagle-row-clean col-12">
            ...
            <div class="row eagle-row-clean col-6">
              ...
              <input id="days" type="text" name="days" class="form-control mac-form-control col-4" value="{{old('days')}}">
              <span class="col-12 invalid-feedback d-none text-center" role="alert" style="padding: 0">
          ...
          <div class="row eagle-row-clean col-12">
            ...
            <input id="start_date" type="date" name="start_date" class="form-control mac-form-control col-5" value="{{old('start_date')}}">
            <span class="col-12 invalid-feedback d-none text-center" role="alert" style="padding: 0">
        ...
        <div class="col-5"> <!-- 3rd column -->
          ...
          <div class="row eagle-row-clean col-12">
            <label class="col-md-3 mac-label-right">Precios de Lista [pesos]:</label>
              <input id="price_1" name="price_1" class="mac-form-control-readonly col-md-3 listprice" style="text-align: center;" readonly>
              <input id="price_7" name="price_7" class="mac-form-control-readonly col-md-3 listprice" style="text-align: center;" readonly>
              <input id="price_30" name="price_30" class="mac-form-control-readonly col-md-3 listprice" style="text-align: center;" readonly>
          </div>
          ...
          <div class="form-group row">
            ...
            <input id="rental_list_price" type="text" name="rental_list_price" class="form-control col-md-2 rental-price" readonly>

            <div class="col-md-2" style="margin: 0; padding: 0">
              <input id="rental_offered_price" type="text" name="rental_offered_price" class="form-control col-md-12 price  rental-price">
              <span class="invalid-feedback d-none text-center" role="alert" style="padding: 0">
                <strong>Debe ingresar el precio acordado</strong>
              </span> 
            </div>

            <input id="discount_offered_price" type="text" name="discount_offered_price" class="form-control col-md-2 discount" value=0 onchange="calcDays()">           
            <input id="net_rental_price" type="text" name="net_rental_price" class="form-control col-md-2 price rental-price" readonly>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-2" style="margin: 0; padding: 0">
              <input id="transport_offered_price" type="text" name="transport_offered_price" class="form-control col-md-12 price rental-price">
              <span class="invalid-feedback d-none text-center" role="alert" style="padding: 0">
                <strong>Debe ingresar el precio acordado</strong>
              </span>
            </div>

            <input id="discount_transport_price" type="text" name="discount_transport_price" class="form-control col-md-2 discount" value=0 onchange="calcDays()">
            <input id="net_transport_price" type="text" name="net_transport_price" class="form-control col-md-2 price rental-price" readonly>
          </div>
          <div class="form-group row">
            <label class="col-md-4 mac-label-right">Otros:</label>
            <input id="other" type="text" name="other" class="form-control col-6" style="font-size: 0.7rem; text-align: left;">
            <input id="other_price" type="text" name="other_price" class="form-control col-md-2 price rental-price" value=0>
          </div>

          <div class="form-group row">
            <label class="col-md-4 mac-label-right">Total:</label>
            <div class="col-md-2"></div>
            <input id="gross_offered_price" type="text" name="gross_offered_price" class="form-control col-md-2 price rental-price" readonly>
            <input id="net_discount" type="text" name="net_discount" class="form-control col-md-2 price rental-price" value=0  readonly>
            <input id="net_offered_price" type="text" name="net_offered_price" class="form-control col-md-2 price rental-price" readonly>
          </div>
    ...
    <div class="modal-footer">
      <button class="btn eagle-button" type="submit">Alquilar</button>
        ...
        if ($.trim(family_id) != '' ) {
          $.get('/rentals/unit_models', {family_id: family_id}, function(unit_models) {
            ...
            $.each(unit_models, function (index, value) {
                $('#unit_model').append("<option value='" + index + "'" + (old == index ? 'selected' : '') + ">" + value +"</option>");
              })
          });
        }
      }
...
//------------------------------------------------------------------------------
  function calcDays() {
    ...
    var price_7 = document.getElementById("price_7").value;
    var price_30 = document.getElementById("price_30").value;
    
      if (days<=2) {
        var period = "Diaria";
        var rental_list_price = price_1 * days * quantity;
      } else if(days>2 && days<=7) {
        var period = "Semanal";
        var rental_list_price = price_7 * quantity;
      } else if(days>7 && days<=20) {
        var period = "Semanal";
        var temp = parseInt(days/7);
        var temp2 = days%7;
        var rental_list_price = ( price_7 * temp + price_7 * temp2/7 ) * quantity;
      } else if(days>20 && days<=30) {
        var period = "Mensual";
        var rental_list_price = price_30 * quantity;
      } else if(days>30) {
        var period = "Mensual";
        var temp3 = parseInt(days/30);
        var temp4 = days%30;
        var rental_list_price = (price_30 * temp3 + price_30 * temp4/30) * quantity;
      } else {
        var period = null};

    $('#period').val(period);

    //var rental_list_price = $('#rental_list_price').val();

    $('#rental_list_price').val(rental_list_price);
   
  };
  calcDays();
  $('#days').on('change', calcDays);
  $('#quantity').on('change', calcDays);
